...
mxShapeBootstrapRRect.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const rSize = parseInt(mxUtils.getValue(this.style, mxShapeBootstrapRRect.prototype.cst.R_SIZE, '10'));
...
mxShapeBootstrapTopButton.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const rSize = parseInt(mxUtils.getValue(this.style, mxShapeBootstrapTopButton.prototype.cst.R_SIZE, '10'));
...
mxShapeBootstrapBottomButton.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const rSize = parseInt(mxUtils.getValue(this.style, mxShapeBootstrapBottomButton.prototype.cst.R_SIZE, '10'));
...
mxShapeBootstrapRightButton.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const rSize = parseInt(mxUtils.getValue(this.style, mxShapeBootstrapRightButton.prototype.cst.R_SIZE, '10'));
...
mxShapeBootstrapLeftButton.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const rSize = parseInt(mxUtils.getValue(this.style, mxShapeBootstrapLeftButton.prototype.cst.R_SIZE, '10'));
...
{
	c.translate(x, y);
	const rSize = Math.max(0, parseInt(mxUtils.getValue(this.style, mxShapeBootstrapTopButton.prototype.cst.R_SIZE, '10')));
	const strokeColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#000000');
	const fillColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, '#ffffff');
...
{
	const isChecked = mxUtils.getValue(this.style, 'checked', false);
	const checkedFill = mxUtils.getValue(this.style, 'checkedFill', '#ffffff');
	const checkedStroke = mxUtils.getValue(this.style, 'checkedStroke', '#000000');
...
{
	const ratingStyle = mxUtils.getValue(this.style, mxShapeBootstrapRating.prototype.cst.RATING_STYLE, mxShapeBootstrapRating.prototype.cst.RATING_STAR);
	const grade = mxUtils.getValue(this.style, mxShapeBootstrapRating.prototype.cst.GRADE, '5');
	const ratingScale = mxUtils.getValue(this.style, mxShapeBootstrapRating.prototype.cst.RATING_SCALE, '10');
	...
	const emptyFillColor = mxUtils.getValue(this.style, mxShapeBootstrapRating.prototype.cst.EMPTY_FILL_COLOR, '#ffffff');
...
mxShapeBootstrapRangeInput.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const rangeStyle = mxUtils.getValue(this.state.style, 'rangeStyle', 'rounded');
	const handleStyle = mxUtils.getValue(this.state.style, 'handleStyle', 'circle');
	const barH = Math.min(h * 0.5, w * 0.5);
	const r = barH * 0.5;
...
mxShapeBootstrapSwitch.prototype.paintVertexShape = function(c, x, y, w, h)
{
	c.translate(x, y);
	w = Math.max(w, 2 * h);
	const state = mxUtils.getValue(this.style, 'buttonState', true);
...
mxShapeInfographicPopover.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const r = parseInt(mxUtils.getValue(this.style, 'rSize', '10'));
	...
	const x1 = Math.max(dx - dy, 0);
	const x2 = Math.min(dx + dy, w);
