...
mxShapeAws3dAMI.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const isShadow = parseFloat(mxUtils.getValue(this.state.style, 'shadow', '0'));
	const strokeWidth1 = strokeWidth * w / 92;
	const strokeWidth2 = strokeWidth * h / 60;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
	...
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dAMI.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
...
mxShapeAws3dSnapshot.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dSnapshot.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[1]) : c.setAlpha(shading[0]); 
...
mxShapeAws3dApplication.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 62;
	const strokeWidth2 = strokeWidth * h / 68.8;
	const isShadow = parseFloat(mxUtils.getValue(this.state.style, 'shadow', '0'));
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dApplication.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dApplicationServer.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 123;
	const strokeWidth2 = strokeWidth * h / 124;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dApplicationServer.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dApplicationServer.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dCloudFront.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 103.8;
	const strokeWidth2 = strokeWidth * h / 169.8;
	const isShadow = parseFloat(mxUtils.getValue(this.state.style, 'shadow', '0'));
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dCloudFront.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dDataCenter.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 123;
	const strokeWidth2 = strokeWidth * h / 142;
	const isShadow = parseFloat(mxUtils.getValue(this.state.style, 'shadow', '0'));
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dDataCenter.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dDataServer.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 123;
	const strokeWidth2 = strokeWidth * h / 106;
	const isShadow = parseFloat(mxUtils.getValue(this.state.style, 'shadow', '0'));
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dDataServer.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dElasticLoadBalancing.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 92;
	const strokeWidth2 = strokeWidth * h / 88.17;
	const strokeColor = mxUtils.getValue(this.state.style, 'strokeColor', '#000000');
	const isShadow = parseFloat(mxUtils.getValue(this.state.style, 'shadow', '0'));
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dElasticLoadBalancing.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dInstance.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 123;
	const strokeWidth2 = strokeWidth * h / 97;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dInstance.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dInstance.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dInternetGateway.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 116.7;
	const strokeWidth2 = strokeWidth * h / 102.8;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dInternetGateway.prototype.background = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dInternetGateway.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
	c.begin();
	c.moveTo(w * 0.4199, h * 0.5447);
...
{
	const fillColor2 = mxUtils.getValue(this.style, 'fillColor2', '#ff0000');
	const fillColor3 = mxUtils.getValue(this.style, 'fillColor3', '#ffffff');
...
mxShapeAws3dRdsMaster.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 123;
	const strokeWidth2 = strokeWidth * h /133;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dRdsMaster.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dRdsMaster.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
{
	const strokeColor3 = mxUtils.getValue(this.style, 'strokeColor3', '#ffffff');

	c.restore();
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dRds.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dRoute53.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 117;
	const strokeWidth2 = strokeWidth * h /134.4;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dRoute53.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dRoute53.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dS3Bucket.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 61.5;
	const strokeWidth2 = strokeWidth * h / 63.8;
	const isShadow = parseFloat(mxUtils.getValue(this.state.style, 'shadow', '0'));
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dS3Bucket.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dS3.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 231.5;
	const strokeWidth2 = strokeWidth * h / 239;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dS3.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dS3.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dSimpleDB.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dSimpleDB.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dSqs.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 184;
	const strokeWidth2 = strokeWidth * h / 212.75;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dSqs.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dSqs.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
	...
	const fillColor = mxUtils.getValue(this.state.style, 'fillColor', '#000000');
...
mxShapeAws3dVpcGateway.prototype.background = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dVpcGateway.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[1]) : c.setAlpha(shading[0]); 
	c.begin();
	c.moveTo(w * 0.5801, h * 0.5447);
...
mxShapeAws3dWebServer.prototype.foreground = function(c, x, y, w, h, strokeWidth)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dWebServer.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dDynamoDB.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 181.5;
	const strokeWidth2 = strokeWidth * h / 210;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dDynamoDB.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dDynamoDB.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dAMI2.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dAMI2.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dEbs.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dEbs.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dSecureConnection.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 57;
	const strokeWidth2 = strokeWidth * h /34;
...
mxShapeAws3dEmailService.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 151;
	const strokeWidth2 = strokeWidth * h / 192;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dEmailService.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dEmailService.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dWorker.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const isShadow = parseFloat(mxUtils.getValue(this.state.style, 'shadow', '0'));
	const strokeWidth1 = strokeWidth * w / 74;
	const strokeWidth2 = strokeWidth * h / 50;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dWorker.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dApplication2.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 62;
	const strokeWidth2 = strokeWidth * h / 53.5;
	const isShadow = parseFloat(mxUtils.getValue(this.state.style, 'shadow', '0'));
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dApplication2.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dElasticBeanstalk.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 181.5;
	const strokeWidth2 = strokeWidth * h / 140;
	const isShadow = parseFloat(mxUtils.getValue(this.state.style, 'shadow', '0'));
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dElasticBeanstalk.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dSimpleDB2.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dSimpleDB2.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dWorkflowService.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dWorkflowService.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dDecider.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	c.restore();
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dDecider.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dSearchEngine.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 180;
	const strokeWidth2 = strokeWidth * h / 192;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dSearchEngine.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dSearchEngine.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dSecurityTokenService.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dSecurityTokenService.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dGlacier.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dGlacier.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dCustomerGateway.prototype.background = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dCustomerGateway.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
	c.begin();
	c.moveTo(w * 0.4199, h * 0.5447);
...
mxShapeAws3dRedshift.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 149.5;
	const strokeWidth2 = strokeWidth * h / 187.5;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dRedshift.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dRedshift.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dLambda.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let strokeWidth = parseFloat(mxUtils.getValue(this.state.style, 'strokeWidth', '1'));
	const strokeWidth1 = strokeWidth * w / 92;
	const strokeWidth2 = strokeWidth * h / 109.5;
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#292929');
...
mxShapeAws3dLambda.prototype.foreground = function(c, x, y, w, h, strokeWidth, strokeColor2)
{
	...
	c.setShadow(false);
	c.setFillColor('#000000');
	const strokeColor = mxUtils.getValue(this.style, 'strokeColor', '#5E5E5E');
	const strokeColor3 = mxUtils.getValue(this.style, 'strokeColor3', '#ffffff');
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dLambda.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
...
mxShapeAws3dEbs2.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const shading = mxUtils.getValue(this.state.style, mxShapeAws3dEbs2.prototype.cst.SHADING_COLORS, '0.1,0.3').toString().split(',');
	const flipH = mxUtils.getValue(this.state.style, 'flipH', '0');
	(flipH == '0') ? c.setAlpha(shading[0]) : c.setAlpha(shading[1]); 
