...
{
	const handles = [Graph.createHandle(state, ['dx'], function(bounds)
	{
...
mxShapeBasicRectCallout.prototype.getLabelMargins = function()
{
	...
	{
		return new mxRectangle(0, 0, 0, Number.parseFloat(mxUtils.getValue(this.style, 'dy', this.dy)) * this.scale);
	}
...
{
	const handles = [Graph.createHandle(state, ['dx', 'dy'], function(bounds)
	{
...
mxShapeBasicRectCallout.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false), new mxConnectionConstraint(new mxPoint(0.25, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0.75, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, (h - dy) * 0.5));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h - dy), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx - dy, h));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h - dy), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - dy) * 0.5));
...
mxShapeBasicRoundRectCallout.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const dy = Math.max(0, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'dy', this.dy))));
	let r = Math.max(0, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'size', this.size))));
...
Graph.handleFactory[mxShapeBasicRoundRectCallout.prototype.cst.ROUND_RECT_CALLOUT] = function(state)
{
	...
	{
		const dx = Math.max(0, Math.min(bounds.width, parseFloat(mxUtils.getValue(this.state.style, 'dx', this.dx))));
		const dy = Math.max(0, Math.min(bounds.height, parseFloat(mxUtils.getValue(this.state.style, 'dy', this.dy))));

		return new mxPoint(bounds.x + dx, bounds.y + bounds.height - dy);
	}, function(bounds, pt)
	{
		const y = parseFloat(mxUtils.getValue(this.state.style, 'dy', this.dy)) * 0.6;
		this.state.style['dx'] = Math.round(100 * Math.max(y, Math.min(bounds.width - y, pt.x - bounds.x))) / 100;
		this.state.style['dy'] = Math.round(Math.max(0, Math.min(bounds.height, bounds.y + bounds.height - pt.y)));
	}), Graph.createHandle(state, ['size'], function(bounds)
	{
		const size = Math.max(0, Math.min(bounds.width, parseFloat(mxUtils.getValue(this.state.style, 'size', this.size))));

		return new mxPoint(bounds.x + bounds.width - size, bounds.y + 10);
	}, function(bounds, pt)
	{
		const dy = parseFloat(mxUtils.getValue(this.state.style, 'dy', this.dy));
...
mxShapeBasicRoundRectCallout.prototype.getConstraints = function(style, w, h)
{
	...
	if (r < w * 0.25)
	{
		constr.push(new mxConnectionConstraint(new mxPoint(0.25, 0), false), new mxConnectionConstraint(new mxPoint(0.75, 0), false));
	}
	
	if (r < (h - dy) * 0.25)
	{
		constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, (h - dy) * 0.25), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, (h - dy) * 0.75));
		constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - dy) * 0.25), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - dy) * 0.75));
	}

	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, r * 0.293, r * 0.293), new mxConnectionConstraint(new mxPoint(0.5, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - r * 0.293, r * 0.293), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, (h - dy) * 0.5));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - dy) * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - r * 0.293, h - dy - r * 0.293));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, r * 0.293, h - dy - r * 0.293), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx - dy, h));
...
mxShapeBasicWave.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const dy = h * Math.max(0, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'dy', this.dy))));
	const fy = 1.4
...
{
	const handles = [Graph.createHandle(state, ['dy'], function(bounds)
	{
...
mxShapeBasicWave.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, dy * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w / 6, h * 0.015));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w / 3, dy * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.5, dy * 0.95));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.67, dy * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.83, h * 0.015));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, dy * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h * 0.5));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h - dy * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.83, h - dy * 0.95));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.67, h - dy * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.5, h - dy * 0.04));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w / 3, h - dy * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w / 6, h - dy * 0.95));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h - dy * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h * 0.5));
...
mxShapeBasicOctagon.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	let dx = Math.max(0, Math.min(w, parseFloat(mxUtils.getValue(this.style, 'dx', this.dx)))) * 2;
...
mxShapeBasicOctagon.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false), new mxConnectionConstraint(new mxPoint(1, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, dx));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, h - dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, h - dx));
...
mxShapeBasicIsoCube.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const isoAngle = Math.max(0.01, Math.min(94, parseFloat(mxUtils.getValue(this.style, 'isoAngle', this.isoAngle)))) * Math.PI / 200 ;
...
{
	const handles = [Graph.createHandle(state, ['isoAngle'], function(bounds)
	{
...
mxShapeBasicIsoCube.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, isoH));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h - isoH));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h - isoH));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, isoH));
...
mxShapeBasicTriangleAcute.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const dx = w * Math.max(0, Math.min(w, parseFloat(mxUtils.getValue(this.style, 'dx', this.dx))));
...
mxShapeBasicTriangleAcute.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(1, 1), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, 0));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx * 0.5, h * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - (w - dx) * 0.5, h * 0.5));
...
mxShapeBasicTriangleObtuse.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false), new mxConnectionConstraint(new mxPoint(1, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.5, h * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w + dx) * 0.5, h));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, h), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx * 0.5, h * 0.5));
...
Graph.handleFactory[mxShapeBasicCone2.prototype.cst.CONE2] = function(state)
{
	...
	const handle2 = Graph.createHandle(state, ['dy'], function(bounds)
	{
		var dy = Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.state.style, 'dy', this.dy))));
...
mxShapeBasicCone2.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, 0), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h - ry));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.5, h), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h - ry));
...
mxShapeBasicPyramid.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const dx1 = w * Math.max(0, Math.min(w, parseFloat(mxUtils.getValue(this.style, 'dx1', this.dx1))));
	const dx2 = w * Math.max(0, Math.min(w, parseFloat(mxUtils.getValue(this.style, 'dx2', this.dx2))));
	const dy1 = h * Math.max(0, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'dy1', this.dy1))));
	const dy2 = h * Math.max(0, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'dy2', this.dy2))));
...
{
	const handles = [Graph.createHandle(state, ['dx1'], function(bounds)
	{
	...
	const handle2 = Graph.createHandle(state, ['dx2'], function(bounds)
	{
	...
	const handle3 = Graph.createHandle(state, ['dy1'], function(bounds)
	{
	...
	const handle4 = Graph.createHandle(state, ['dy2'], function(bounds)
	{
...
mxShapeBasicPyramid.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx1, 0), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w + dx1) * 0.5, dy2 * 0.5));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, dy2), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w + dx2) * 0.5, (h + dy2) * 0.5));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx2, h), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx2 * 0.5, (h + dy1) * 0.5));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, dy1), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx1 * 0.5, dy1 * 0.5));
...
mxShapeBasic4PointStar2.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const dx = 0.5 * Math.max(0, Math.min(w, parseFloat(mxUtils.getValue(this.style, 'dx', this.dx))));
...
mxShapeBasic4PointStar2.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false), new mxConnectionConstraint(new mxPoint(1, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(dx, dx), false), new mxConnectionConstraint(new mxPoint(1 - dx, dx), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1 - dx, 1 - dx), false), new mxConnectionConstraint(new mxPoint(dx, 1 - dx), false));
...
mxShapeBasicDiagSnipRect.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, dx), new mxConnectionConstraint(new mxPoint(0.5, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false), new mxConnectionConstraint(new mxPoint(1, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, h - dx), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false), new mxConnectionConstraint(new mxPoint(0, 0.5), false));
...
mxShapeBasicDiagRoundRect.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(1, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false), new mxConnectionConstraint(new mxPoint(0, 0.5), false));
...
mxShapeBasicCornerRoundRect.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(1, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false), new mxConnectionConstraint(new mxPoint(1, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false), new mxConnectionConstraint(new mxPoint(0, 1), false));
...
mxShapeBasicPlaque.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(1, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false), new mxConnectionConstraint(new mxPoint(0, 0.5), false));
...
mxShapeBasicFrame.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.25, 0));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.75, 0));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h * 0.25));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h * 0.75));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 1), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.75, h));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w * 0.25, h));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h * 0.75));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h * 0.25));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - 2 * dx)* 0.25 + dx, dx));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false, null, 0, dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w * 1.5 - dx) * 0.5, dx));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false, null, -dx, dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, (h - 2 * dx)* 0.25 + dx));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false, null, -dx, 0), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, (h  - 2 * dx) * 0.75 + dx));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 1), false, null, -dx, -dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - 2 * dx) * 0.75 + dx, h - dx));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false, null, 0, -dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w  - 2 * dx) * 0.25 + dx, h - dx));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false, null, dx, -dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, (h - 2 * dx) * 0.75 + dx));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false, null, dx, 0), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, (h - 2 * dx) * 0.25 + dx));
...
mxShapeBasicPlaqueFrame.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(1, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false), new mxConnectionConstraint(new mxPoint(0, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false, null, 0, dx), new mxConnectionConstraint(new mxPoint(1, 0.5), false, null, -dx, 0));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false, null, 0, -dx), new mxConnectionConstraint(new mxPoint(0, 0.5), false, null, dx, 0));
...
mxShapeBasicFrameCorner.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false), new mxConnectionConstraint(new mxPoint(0.5, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false), new mxConnectionConstraint(new mxPoint(1, 0), false, null, -dx, dx));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - 2 * dx) * 0.5 + dx, dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, dx));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, (h - 2 * dx) * 0.5 + dx), new mxConnectionConstraint(new mxPoint(0, 1), false, null, dx, -dx));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false), new mxConnectionConstraint(new mxPoint(0, 0.5), false));
...
mxShapeBasicDiagStripe.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false), new mxConnectionConstraint(new mxPoint(0.5, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, Math.min(dx * 100 / w, h) * 0.5));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, Math.min(dx * 100 / w, h)), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w + Math.min(dx * 100 / h, w)) * 0.5, (Math.min(dx * 100 / w, h) + h) * 0.5));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, Math.min(dx * 100 / h, w), h), new mxConnectionConstraint(new mxPoint(0, 0), false, null, Math.min(dx * 100 / h, w) * 0.5, h));
...
mxShapeBasicLayeredRect.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - dx) * 0.25, 0));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - dx) * 0.5, 0), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - dx) * 0.75, 0));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx, 0), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - dx * 0.5, dx * 0.5));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, (h - dx) * 0.25 + dx));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, (h - dx) * 0.5 + dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, (h - dx) * 0.75 + dx));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, w, h), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - dx) * 0.75 + dx, h));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - dx) * 0.5 + dx, h), new mxConnectionConstraint(new mxPoint(0, 0), false, null, (w - dx) * 0.25 + dx, h));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx, h), new mxConnectionConstraint(new mxPoint(0, 0), false, null, dx * 0.5, h - dx * 0.5));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, h - dx), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - dx) * 0.75));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - dx) * 0.5), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - dx) * 0.25));
...
{
	c.translate(x, y);
	const startAngleSource = Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'startAngle', this.startAngle))));
	const endAngleSource = Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'endAngle', this.endAngle))));
	const startAngle = 2 * Math.PI * startAngleSource;
	const endAngle = 2 * Math.PI * endAngleSource;
	const rx = w * 0.5;
	const ry = h * 0.5;
	...
	c.begin();
	const startAngleDiff = startAngleSource % 1;
	const endAngleDiff = endAngleSource % 1;
...
{
	const handles = [Graph.createHandle(state, ['startAngle'], function(bounds)
	{
	...
	const handle2 = Graph.createHandle(state, ['endAngle'], function(bounds)
	{
...
mxShapeBasicArc.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	// Arrow markers
	const startArrow = mxUtils.getValue(this.style, mxConstants.STYLE_STARTARROW, mxConstants.NONE);
	const endArrow = mxUtils.getValue(this.style, mxConstants.STYLE_ENDARROW, mxConstants.NONE);
	const startSize = mxUtils.getNumber(this.style, mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_MARKERSIZE);
	const endSize = mxUtils.getNumber(this.style, mxConstants.STYLE_ENDSIZE, mxConstants.DEFAULT_MARKERSIZE);
	...
	const cx = w * 0.5;
	const cy = h * 0.5;
	const rx = Math.max(0, w * 0.5 - markerPadding);
	const ry = Math.max(0, h * 0.5 - markerPadding);

	let startX = cx + Math.sin(startAngle) * rx;
	let startY = cy - Math.cos(startAngle) * ry;
	let endX = cx + Math.sin(endAngle) * rx;
	let endY = cy - Math.cos(endAngle) * ry;
	...
	if (startArrow != null && startArrow != mxConstants.NONE)
	{
		const startFilled = this.style[mxConstants.STYLE_STARTFILL] != 0;
	...
	if (endArrow != null && endArrow != mxConstants.NONE)
	{
		const endFilled = this.style[mxConstants.STYLE_ENDFILL] != 0;
...
mxShapeBasicPartConcEllipse.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const startAngle = 2 * Math.PI * Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'startAngle', this.startAngle))));
	let endAngle = 2 * Math.PI * Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'endAngle', this.endAngle))));
	const arcWidth = 1 - Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'arcWidth', this.arcWidth))));
	const rx = w * 0.5;
	const ry = h * 0.5;
	const rx2 = rx * arcWidth;
	const ry2 = ry * arcWidth;
	...
	const startX = rx + Math.sin(startAngle) * rx;
	const startY = ry - Math.cos(startAngle) * ry;
	const innerStartX = rx + Math.sin(startAngle) * rx2;
	const innerStartY = ry - Math.cos(startAngle) * ry2;
	const endX = rx + Math.sin(endAngle) * rx;
	const endY = ry - Math.cos(endAngle) * ry;
	const innerEndX = rx + Math.sin(endAngle) * rx2;
	const innerEndY = ry - Math.cos(endAngle) * ry2;
...
Graph.handleFactory[mxShapeBasicPartConcEllipse.prototype.cst.PART_CONC_ELLIPSE] = function(state)
{
	...
	const handle3 = Graph.createHandle(state, ['arcWidth'], function(bounds)
	{
...
mxShapeBasicNumEntryVert.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const dy = Math.max(0, Math.min(w, parseFloat(mxUtils.getValue(this.style, 'dy', this.dy))));

	const inset = 5;

	const d = Math.min(dy, w - 2 * inset, h - inset);
...
mxShapeBasicBendingArch.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const startAngle = 2 * Math.PI * Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'startAngle', this.startAngle))));
	const endAngle = 2 * Math.PI * Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'endAngle', this.endAngle))));
	const arcWidth = 1 - Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'arcWidth', this.arcWidth))));
	const rx = w * 0.5;
	const ry = h * 0.5;
	const rx2 = rx * arcWidth;
...
mxShapeBasicPolygon.prototype.paintVertexShape = function(c, x, y, w, h)
{
    ...
    {
        c.translate(x, y);
        const coords = JSON.parse(mxUtils.getValue(this.state.style, 'polyCoords', '[]'));
        const curves = JSON.parse(mxUtils.getValue(this.state.style, 'polyCurves', '[]'));
        const polyline = mxUtils.getValue(this.style, 'polyline', false);
        ...
        if (coords.length > 0)
        {
            ...
            {
                const ci = (curves.length > i - 1) ? curves[i - 1] : null;
            ...
            if (polyline == false)
            {
                const closeCurve = (curves.length >= coords.length) ? curves[coords.length - 1] : null;
...
(function()
{
    function createPolygonHandles(state)
    {
        ...
        try
        {
            const coords = JSON.parse(mxUtils.getValue(state.style, 'polyCoords', '[]'));
            const curves = JSON.parse(mxUtils.getValue(state.style, 'polyCurves', '[]'));
            const polyline = mxUtils.getValue(state.style, 'polyline', 0);
            const isPolyline = polyline == 1 || polyline === true || polyline === 'true' || polyline === '1';
            ...
            {
                const handler = state.view.graph.selectionCellsHandler.getHandler(state.cell);
            ...
            for (var i = 0; i < coords.length; i++)
            {
                (function(index)
                {
                    const handle = Graph.createHandle(state, ['polyCoords', 'polyCurves'], function(bounds)
                    {
                    ...
                    const vertexOrigExecute = handle.execute;
                    ...
                    handle.execute = function(me)
                    {
                        if (coords.length > minPoints)
                        {
                            ...
                            const canRemove = !isPolyline || (index > 0 && index < n - 1);

                            if (canRemove)
                            {
                                const bounds = this.state.getPaintBounds();
                                const px = coords[prevIdx][0] * bounds.width;
                                const py = coords[prevIdx][1] * bounds.height;
                                const nx = coords[nextIdx][0] * bounds.width;
                                const ny = coords[nextIdx][1] * bounds.height;
                                const cx = coords[index][0] * bounds.width;
                                const cy = coords[index][1] * bounds.height;
            ...
            for (var i = 0; i < curves.length && i < coords.length; i++)
            {
                (function(segIndex)
                {
                    ...
                    {
                        const cpHandle = Graph.createHandle(state, ['polyCurves'], function(bounds)
                        {
                        ...
                        const cpOrigRedraw = cpHandle.redraw;
...
mxShapeBasicPatternFillRect.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const strokeWidth = mxUtils.getValue(this.style, 'strokeWidth', '1');
	
	c.rect(0, 0, w, h);
	c.fill();

	const fillStrokeColor = mxUtils.getValue(this.style, 'fillStrokeColor', '#cccccc');
	const fillStrokeWidth = parseFloat(mxUtils.getValue(this.style, 'fillStrokeWidth', 1));
	
	c.setStrokeColor(fillStrokeColor);
	c.setStrokeWidth(fillStrokeWidth);
	
	let step = parseFloat(mxUtils.getValue(this.style, 'step', 5));
	const fillStyle = mxUtils.getValue(this.style, 'fillStyle', 'none');
...
mxShapeBasicPatternFillRect.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false), new mxConnectionConstraint(new mxPoint(0.25, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0.75, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false), new mxConnectionConstraint(new mxPoint(1, 0.25), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false), new mxConnectionConstraint(new mxPoint(1, 0.75), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 1), false), new mxConnectionConstraint(new mxPoint(0.75, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.75, 1), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.25, 1), false), new mxConnectionConstraint(new mxPoint(0, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.75), false), new mxConnectionConstraint(new mxPoint(0, 0.5), false));
