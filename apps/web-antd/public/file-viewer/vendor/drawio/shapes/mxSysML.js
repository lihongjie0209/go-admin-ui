...
mxShapeSysMLComposite.prototype.paintForeground = function(c, x, y, w, h)
{
	if (this.style != null)
	{
		let shape = mxCellRenderer.defaultShapes[this.style['symbol0']];
		...
		do
		{
			...
			if (shape != null)
			{
				...
				let vspacing = this.style['symbol' + counter + 'VSpacing'] || 0;
				const arcspacing = this.style['symbol' + counter + 'ArcSpacing'];
				const direction = this.style['symbol' + counter + 'Direction'];
...
{
	let xSize = parseInt(mxUtils.getValue(this.style, mxShapeSysMLPackage.prototype.cst.LABEL_X, '90'));
	const ySize = 20;
...
{
	const handles = [Graph.createHandle(state, ['labelX'], function(bounds)
			{
...
{
	let xSize = parseInt(mxUtils.getValue(this.style, mxShapeSysMLPackage2.prototype.cst.LABEL_X, '90'));
	const ySize = 20;
...
mxShapeSysMLPortOne.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0.05, 0), false), new mxConnectionConstraint(new mxPoint(0.25, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0.75, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.95, 0), false), new mxConnectionConstraint(new mxPoint(0.95, 0.25), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.95, 0.75), false), new mxConnectionConstraint(new mxPoint(0.95, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.75, 1), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.25, 1), false), new mxConnectionConstraint(new mxPoint(0.05, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.05, 0.75), false), new mxConnectionConstraint(new mxPoint(0.05, 0.25), false));
...
mxShapeSysMLPortThree.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	c.fillAndStroke();
	this.drawIn(c, x + w * 0.01, y + h * 0.2, w * 0.11, h * 0.1);
	this.drawOut(c, x + w * 0.02, y + h * 0.7, w * 0.11, h * 0.1);
	this.drawInOut(c, x + w * 0.88, y + h * 0.45, w * 0.1, h * 0.1);
};
...
{
	const flowDir = mxUtils.getValue(this.style, mxShapeSysMLItemFlow.prototype.cst.FLOW_DIR, 'none').toLowerCase();
	const flowType = mxUtils.getValue(this.style, mxShapeSysMLItemFlow.prototype.cst.FLOW_TYPE, 'none');
...
mxMarker.addMarker('sysMLReqInt', function(c, shape, type, pe, unitX, unitY, size, source, sw, filled)
{
	...
	return function()
	{
		const fillColor = mxUtils.getValue(shape.style, mxConstants.STYLE_FILLCOLOR, 'none');
...
mxShapeSysMLCallBehaviorAction.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 2.9, 2.9), new mxConnectionConstraint(new mxPoint(0.25, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0.75, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false, null, -2.9, 2.9), new mxConnectionConstraint(new mxPoint(1, 0.25), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false), new mxConnectionConstraint(new mxPoint(1, 0.75), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 1), false, null, -2.9, -2.9), new mxConnectionConstraint(new mxPoint(0.75, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false), new mxConnectionConstraint(new mxPoint(0.25, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.75, 1), false), new mxConnectionConstraint(new mxPoint(0, 1), false, null, 2.9, -2.9));
...
mxShapeSysMLAcceptEventAction.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(1, 1), false), new mxConnectionConstraint(new mxPoint(0.75, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false), new mxConnectionConstraint(new mxPoint(0.25, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false), new mxConnectionConstraint(new mxPoint(0, 0.5), false, null,  h * 0.3, 0));
...
mxShapeSysMLSendSignalAction.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false), new mxConnectionConstraint(new mxPoint(0.25, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0.75, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false, null, -h * 0.3, 0), new mxConnectionConstraint(new mxPoint(1, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 1), false, null, -h * 0.3, 0), new mxConnectionConstraint(new mxPoint(0.25, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false), new mxConnectionConstraint(new mxPoint(0.75, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 1), false), new mxConnectionConstraint(new mxPoint(0, 0.25), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false), new mxConnectionConstraint(new mxPoint(0, 0.75), false));
...
mxShapeSysMLActivityParameterNode.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	c.begin();
	const minX = Math.max(w * 0.35, 70);
	const maxX = Math.min(w * 0.65, w - 10);
	c.begin();
	c.moveTo(minX, h);
	c.lineTo(10, h);
	c.lineTo(10, 0);
...
mxShapeSysMLActivityParameterNode.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.35), false), new mxConnectionConstraint(new mxPoint(0, 0.65), false));
...
mxShapeSysMLIsStream.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const strokeColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#000000');
	const fillColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, '#ffffff');
...
mxShapeSysMLParameterSet.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false, null, 0, -14), new mxConnectionConstraint(new mxPoint(0, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false, null, 0, 14), new mxConnectionConstraint(new mxPoint(1, 0.5), false, null, 0, -14));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.5), false), new mxConnectionConstraint(new mxPoint(1, 0.5), false, null, 0, 14));
	constr.push(new mxConnectionConstraint(new mxPoint(0.25, 0), false), new mxConnectionConstraint(new mxPoint(0.5, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.75, 0), false), new mxConnectionConstraint(new mxPoint(0.25, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 1), false), new mxConnectionConstraint(new mxPoint(0.75, 1), false));
...
mxShapeSysMLProbability.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.25), false), new mxConnectionConstraint(new mxPoint(0, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.75), false), new mxConnectionConstraint(new mxPoint(1, 0.25), false, null, 0, -14));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.25), false, null, 0, 14), new mxConnectionConstraint(new mxPoint(1, 0.25), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.75), false, null, 0, -14), new mxConnectionConstraint(new mxPoint(1, 0.75), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.75), false, null, 0, 14), new mxConnectionConstraint(new mxPoint(0.25, 0), false, null, -5, 0));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false, null, -5, 0), new mxConnectionConstraint(new mxPoint(0.75, 0), false, null, -5, 0));
	constr.push(new mxConnectionConstraint(new mxPoint(0.25, 1), false, null, -5, 0), new mxConnectionConstraint(new mxPoint(0.5, 1), false, null, -5, 0));
...
mxShapeSysMLObjectFlowRight.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false), new mxConnectionConstraint(new mxPoint(1, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false, null, -5, 0), new mxConnectionConstraint(new mxPoint(0.5, 1), false, null, -5, 0));
...
mxShapeSysMLContinuation.prototype.getConstraints = function(style, w, h)
{
	...
	if (w > h)
	{
		...
		if (w > 2 * h)
		{
			...
			constr.push(new mxConnectionConstraint(new mxPoint(0.25, 1), false), new mxConnectionConstraint(new mxPoint(0.75, 1), false));
		}
	}
	else
	{
		...
		if (h > 2 * w)
		{
			constr.push(new mxConnectionConstraint(new mxPoint(0, 0.25), false), new mxConnectionConstraint(new mxPoint(0, 0.75), false));
			constr.push(new mxConnectionConstraint(new mxPoint(1, 0.25), false), new mxConnectionConstraint(new mxPoint(1, 0.75), false));
		}
	}

	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, r * 0.29, r * 0.29), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - r * 0.29, r * 0.29));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, r * 0.29, h - r * 0.29), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - r * 0.29, h - r * 0.29));
...
mxMarker.addMarker('sysMLLost', function(c, shape, type, pe, unitX, unitY, size, source, sw, filled)
{
	...
	return function()
	{
		...
		const strokeColor = mxUtils.getValue(shape.style, mxConstants.STYLE_STROKECOLOR, '#000000');
		c.setFillColor(strokeColor);
		c.fillAndStroke();
	};
});
...
mxShapeSysMLCompositeState.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 2.9, 22.9), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - 2.9, 22.9));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 2.9, h - 2.9), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - 2.9, h - 2.9));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - 20) * 0.25 + 20), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - 20) * 0.5 + 20));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, (h - 20) * 0.75 + 20), new mxConnectionConstraint(new mxPoint(1, 0), false, null, 0, (h - 20) * 0.25 + 20));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false, null, 0, (h - 20) * 0.5 + 20), new mxConnectionConstraint(new mxPoint(1, 0), false, null, 0, (h - 20) * 0.75 + 20));
	constr.push(new mxConnectionConstraint(new mxPoint(0.25, 1), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.75, 1), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 15, 0));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 70, 0), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 125, 0));
...
{
	const strokeW = parseInt(mxUtils.getValue(this.style, mxConstants.STYLE_STROKEWIDTH, '1'));
	c.roundrect(0, tabH, w, h - tabH, 10, 10);
	c.fillAndStroke();
...
mxShapeSysMLRegion.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0.25, 1), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.75, 1), false), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 15, 0));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 40, 0), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 65, 0));
...
mxShapeSysMLSimpleState.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 2.9, 2.9), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - 2.9, 2.9));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 2.9, h - 2.9), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - 2.9, h - 2.9));
	constr.push(new mxConnectionConstraint(new mxPoint(0.25, 1), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.75, 1), false), new mxConnectionConstraint(new mxPoint(0.25, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0.75, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.25), false), new mxConnectionConstraint(new mxPoint(1, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.75), false), new mxConnectionConstraint(new mxPoint(0, 0.25), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false), new mxConnectionConstraint(new mxPoint(0, 0.75), false));
...
{
	const strokeC = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, '#000000');
...
mxShapeSysMLStateMachine.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 2.9, 2.9), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - 12.9, 2.9));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, 2.9, h - 2.9), new mxConnectionConstraint(new mxPoint(0, 0), false, null, w - 12.9, h - 2.9));
	constr.push(new mxConnectionConstraint(new mxPoint(0.25, 1), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.75, 1), false), new mxConnectionConstraint(new mxPoint(0.25, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0.75, 0), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.25), false, null, -10, 0), new mxConnectionConstraint(new mxPoint(1, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0.75), false, null, -10, 0), new mxConnectionConstraint(new mxPoint(0, 0.25), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false), new mxConnectionConstraint(new mxPoint(0, 0.75), false));
...
mxShapeSysMLX.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false), new mxConnectionConstraint(new mxPoint(0, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(1, 0), false), new mxConnectionConstraint(new mxPoint(1, 1), false));
...
mxShapeSysMLUseCaseExtensionPoints.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false), new mxConnectionConstraint(new mxPoint(1, 0.5), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.5, 0), false), new mxConnectionConstraint(new mxPoint(0.5, 1), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.145, 0.145), false), new mxConnectionConstraint(new mxPoint(0.145, 0.855), false));
	constr.push(new mxConnectionConstraint(new mxPoint(0.855, 0.855), false), new mxConnectionConstraint(new mxPoint(0.855, 0.145), false));
...
mxShapeSysMLPort.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	c.rect(0, 0, w, h);
	c.fillAndStroke();
	const portType = mxUtils.getValue(this.style, 'sysMLPortType', 'empty');
