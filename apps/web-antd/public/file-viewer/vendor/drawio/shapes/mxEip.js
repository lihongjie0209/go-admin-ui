...
mxShapeEipMessageChannel.prototype.getConstraints = function(style, w, h)
{
	...
	constr.push(new mxConnectionConstraint(new mxPoint(0, 0.5), false, null, 2.7, 0), new mxConnectionConstraint(new mxPoint(1, 0.5), false, null, -2.7, 0));

	let currW = 10;
	
	while (currW < w)
	{
		constr.push(new mxConnectionConstraint(new mxPoint(0, 0), false, null, currW, 0), new mxConnectionConstraint(new mxPoint(0, 1), false, null, currW, 0));
