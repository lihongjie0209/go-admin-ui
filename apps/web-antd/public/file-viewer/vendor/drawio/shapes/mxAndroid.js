...
{
	const textStrings = mxUtils.getValue(this.style, mxShapeAndroidTabBar.prototype.cst.MAIN_TEXT, '+Tab 1, Tab 2, Tab 3').toString().split(',');
	const fontColor = mxUtils.getValue(this.style, mxShapeAndroidTabBar.prototype.cst.TEXT_COLOR, 'none');
	const selectedFontColor = mxUtils.getValue(this.style, mxShapeAndroidTabBar.prototype.cst.TEXT_COLOR2, 'none');
	const fontSize = mxUtils.getValue(this.style, mxShapeAndroidTabBar.prototype.cst.TEXT_SIZE, '17').toString();
	const frameColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, 'none');
	const separatorColor = mxUtils.getValue(this.style, mxShapeAndroidTabBar.prototype.cst.STROKE_COLOR2, 'none');
	const bgColor = mxUtils.getValue(this.style, mxConstants.STYLE_FILLCOLOR, 'none');
	const selectedFillColor = mxUtils.getValue(this.style, mxShapeAndroidTabBar.prototype.cst.FILL_COLOR2, 'none');
	...
	const trueH = Math.max(h, fontSize * 1.5, 7);
...
mxShapeAndroidCheckboxGroup.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const fontColor = mxUtils.getValue(this.style, mxConstants.STYLE_TEXTCOLOR, '#666666');
	const fontSize = mxUtils.getValue(this.style, mxConstants.STYLE_FONTSIZE, '8').toString();
	const optionText = mxUtils.getValue(this.style, mxShapeAndroidCheckboxGroup.prototype.cst.BUTTON_TEXT, 'Option 1').toString().split(',');
	const strokeColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, 'none');
	const strokeColor2 = mxUtils.getValue(this.style, mxShapeAndroidCheckboxGroup.prototype.cst.STYLE_STROKECOLOR2, 'none');
...
mxShapeAndroidRadioGroup.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const fontColor = mxUtils.getValue(this.style, mxConstants.STYLE_TEXTCOLOR, '#666666');
	const fontSize = mxUtils.getValue(this.style, mxConstants.STYLE_FONTSIZE, '8').toString();
	const optionText = mxUtils.getValue(this.style, mxShapeAndroidRadioGroup.prototype.cst.BUTTON_TEXT, 'Option 1').toString().split(',');
	const strokeColor = mxUtils.getValue(this.style, mxConstants.STYLE_STROKECOLOR, 'none');
	const strokeColor2 = mxUtils.getValue(this.style, mxShapeAndroidRadioGroup.prototype.cst.STYLE_STROKECOLOR2, 'none');
...
{
	const textStrings = mxUtils.getValue(this.style, mxShapeAndroidMenuBar.prototype.cst.MENU_TEXT, 'Item 1, Item 2, Item 3').toString().split(',');
	const fontSize = mxUtils.getValue(this.style, mxConstants.STYLE_FONTSIZE, '12');
	const buttonNum = textStrings.length;
	...
	for (var i = 0; i < buttonNum; i++)
	{
		const buttonText = textStrings[i];
...
mxShapeAndroidTextSelHandles.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const handleSizeX = 15;
	const barH = Math.max(0, h - handleSizeX * 1.5);
	c.setAlpha(0.5);
...
{
	const spinnerColor = mxUtils.getValue(this.style, 'spinnerColor', 'none');
	let darkStop, midStop, brightStop;
...
mxShapeAndroidRRect.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const rSize = parseInt(mxUtils.getValue(this.style, mxShapeAndroidRRect.prototype.cst.R_SIZE, '10'));
...
mxShapeAndroidProgressBar.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#444444');
...
{
	const dx = w * Math.max(0, Math.min(w, parseFloat(mxUtils.getValue(this.style, 'dx', this.dx))));
	const fillColor = mxUtils.getValue(this.style, 'fillColor', '#ffffff');
	const strokeColor2 = mxUtils.getValue(this.style, 'strokeColor2', '#444444');
...
{
	const dy = Math.min(h - 20, Math.max(20, h * Math.max(0, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'dy', this.dy))))));
	const fillColor = mxUtils.getValue(this.style, 'fillColor', '#ffffff');
	const fillColor2 = mxUtils.getValue(this.style, 'fillColor2', '#cccccc');
	const fillColor3 = mxUtils.getValue(this.style, 'fillColor3', '#666666');
...
{
	const dy = Math.min(h - 10, Math.max(10, h * Math.max(0, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'dy', this.dy))))));
	const fillColor = mxUtils.getValue(this.style, 'fillColor', '#ffffff');
	const fillColor2 = mxUtils.getValue(this.style, 'fillColor2', '#cccccc');
