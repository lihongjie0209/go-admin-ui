...
mxAtlassianJiraIssue.prototype.paintForeground = function(c, x, y, w, h)
{
	...
	const issueType = mxUtils.getValue(this.style, 'issueType', 'task');
	const issuePriority = mxUtils.getValue(this.style, 'issuePriority', 'minor');
	const issueStatus = mxUtils.getValue(this.style, 'issueStatus', 'todo');
