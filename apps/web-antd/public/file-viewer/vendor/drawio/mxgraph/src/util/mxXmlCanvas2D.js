...
mxXmlCanvas2D.prototype.save = function()
{
	...
	this.root.append(this.createElement('save'));
};
...
mxXmlCanvas2D.prototype.restore = function()
{
	...
	this.root.append(this.createElement('restore'));
};
...
mxXmlCanvas2D.prototype.setFillColor = function(value)
{
	...
	elem.setAttribute('color', (value == null) ? mxConstants.NONE : value);
	this.root.append(elem);
};
...
{
	this.root.append(this.createElement('begin'));
	this.lastX = 0;
	this.lastY = 0;
};
...
{
	this.root.append(this.createElement('close'));
};
...
{
	this.root.append(this.createElement('stroke'));
};
...
{
	this.root.append(this.createElement('fill'));
};
...
{
	this.root.append(this.createElement('fillstroke'));
};
