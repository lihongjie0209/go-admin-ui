...
function mxCellMarker(graph, validColor, invalidColor, hotspot)
{
	...
	{
		this.graph = graph;
		this.validColor = (validColor == null) ? mxConstants.DEFAULT_VALID_COLOR : validColor;
		this.invalidColor = (invalidColor == null) ? mxConstants.DEFAULT_INVALID_COLOR : invalidColor;
		this.hotspot = (hotspot == null) ? mxConstants.DEFAULT_HOTSPOT : hotspot;
...
mxCellMarker.prototype.setCurrentState = function(state, me, color)
{
	...
	color = (color == null) ? this.getMarkerColor(me.getEvent(), state, isValid) : color;
...
mxCellMarker.prototype.markCell = function(cell, color)
{
	...
	if (state != null)
	{
		this.currentColor = (color == null) ? this.validColor : color;
		this.markedState = state;
		this.mark();
	}
};
