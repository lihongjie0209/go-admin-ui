 ...
 */
mxPopupMenu.prototype.zIndex = 10_006;
...
{
	const img = this.addImage(item.firstChild.nextSibling, icon);
...
mxPopupMenu.prototype.createSubmenu = function(parent)
{
	...
	parent.div.append(parent.table);

	const img = this.addImage(parent.firstChild.nextSibling.nextSibling, this.submenuImage);
