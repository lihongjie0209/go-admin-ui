...
mxOutline.prototype.updateSvg = function()
{
	...
	const color = mxUtils.getLightDarkColor((this.source.background == null ||
...
{
	const s = this.source.view.scale;
	
	Array.prototype.slice.call(svg.querySelectorAll('*')).forEach(
