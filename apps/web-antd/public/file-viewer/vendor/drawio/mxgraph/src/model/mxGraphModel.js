...
{
	return (this.cells == null) ? null : this.cells[id];
};
...
{
	return (cell == null) ? null : cell.getParent();
};
...
{
	return (cell == null) ? 0 : cell.getChildCount();
};
...
{
	return (cell == null) ? null : cell.getChildAt(index);
};
...
{
	return (cell == null) ? null : cell.children;
};
...
{
	return (edge == null) ? null : edge.getTerminal(isSource);
};
...
{
	return (cell == null) ? 0 : cell.getEdgeCount();
};
...
{
	return (cell == null) ? null : cell.getEdgeAt(index);
};
...
{
	return (cell == null) ? false : cell.isVertex();
};
...
{
	return (cell == null) ? false : cell.isEdge();
};
...
{
	return (cell == null) ? false : cell.isConnectable();
};
...
{
	return (cell == null) ? null : cell.getGeometry();
};
...
{
	return (cell == null) ? null : cell.getStyle();
};
...
{
	return (cell == null) ? false : cell.isCollapsed();
};
...
{
	cloneAllEdges = (cloneAllEdges == null) ? true : cloneAllEdges;
...
{
	includeChildren = (includeChildren == null) ? true : includeChildren;
	mapping = (mapping == null) ? new Object() : mapping;
	identical = (identical == null) ? false : identical;
	const clones = [];
...
{
	isConnect = (isConnect == null) ? true : isConnect;
