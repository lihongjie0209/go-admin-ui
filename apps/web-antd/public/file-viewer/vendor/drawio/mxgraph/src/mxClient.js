 ...
 * (end)
 */
if ((mxResourceExtension) === undefined)
{
 ...
 * (end)
 */
if ((mxLoadStylesheets) === undefined)
{
 ...
 */
if ((mxBasePath) !== undefined && mxBasePath.length > 0)
{
 ...
 * contains the assignment. Trailing slashes are automatically removed.
 */
if ((mxImageBasePath) !== undefined && mxImageBasePath.length > 0)
{
	// Adds a trailing slash if required
 ...
 */
if ((mxLanguage) !== undefined && mxLanguage != null)
{
 ...
 * (end)
 */
if ((mxDefaultLanguage) !== undefined && mxDefaultLanguage != null)
{
 ...
 * will be returned.
 */
if ((mxLanguages) !== undefined && mxLanguages != null)
{
