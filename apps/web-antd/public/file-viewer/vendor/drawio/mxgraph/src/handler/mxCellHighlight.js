...
function mxCellHighlight(graph, highlightColor, strokeWidth, dashed)
{
	...
	{
		this.graph = graph;
		this.highlightColor = (highlightColor == null) ? mxConstants.DEFAULT_VALID_COLOR : highlightColor;
		this.strokeWidth = (strokeWidth == null) ? mxConstants.HIGHLIGHT_STROKEWIDTH : strokeWidth;
		this.dashed = (dashed == null) ? false : dashed;
