...
mxGraphHandler.prototype.isPropagateSelectionCell = function(cell, immediate, me)
{
	...
	if (immediate)
	{
		const geo = (this.graph.model.isEdge(cell)) ? null :
...
mxGraphHandler.prototype.getInitialCellForEvent = function(me)
{
	...
	return (state == null) ? null : state.cell;
};
...
mxGraphHandler.prototype.getCells = function(initialCell, cells)
{
	...
	{
		cells = (cells == null) ? this.graph.getSelectionCells() : cells;
...
mxGraphHandler.prototype.start = function(cell, x, y, cells)
{
		...
		this.graph.allowDanglingEdges)))
	{
		...
		this.cells = (cells == null) ? this.getCells(this.cell) : cells;
		this.bounds = this.graph.getView().getBounds(this.cells);
		this.pBounds = this.getPreviewBounds(this.cells);
...
{
	return (this.guide == null) ? true : this.guide.isEnabledForEvent(me.getEvent()) &&
