...
mxConnectionHandler.prototype.start = function(state, x, y, edgeState)
{
	...
	this.edgeState = (edgeState == null) ? this.createEdgeState(null) : edgeState;
...
mxConnectionHandler.prototype.getIconPosition = function(icon, state)
{
	...
	if (this.graph.isSwimlane(state.cell))
	{
		...
		cx = (size.width == 0) ? cx : state.x + size.width * scale / 2;
		cy = (size.height == 0) ? cy : state.y + size.height * scale / 2;
...
mxConnectionHandler.prototype.updateEdgeState = function(current, constraint)
{
	...
	this.edgeState.absolutePoints = [null, (this.currentState == null) ? current : null];
