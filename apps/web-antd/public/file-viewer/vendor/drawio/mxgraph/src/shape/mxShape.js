...
mxShape.prototype.createDropShadow = function(style, scale)
{
	...
	const cssColor = mxUtils.getLightDarkColor(color, alpha);
...
mxShape.prototype.paint = function(c)
{
		...
		(this.stencil != null && this.stencilPointerEvents))
	{
		...
		else
		{
			...
			rect.append(c.createTransparentFill());
			rect.stroked = 'false';
			c.root.append(rect);
		}
	}
...
mxShape.prototype.configureCanvas = function(c, x, y, w, h)
{
	...
	if (this.isDashed != null)
	{
		c.setDashed(this.isDashed, (this.style == null) ? false : mxUtils.getValue(
...
mxShape.prototype.addPoints = function(c, pts, rounded, arcSize, close, exclude, initialMove)
{
	...
	{
		initialMove = (initialMove == null) ? true : initialMove;
