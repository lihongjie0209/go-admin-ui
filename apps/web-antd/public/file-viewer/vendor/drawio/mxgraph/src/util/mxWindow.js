...
function mxWindow(title, content, x, y, width, height, minimizable, movable, replaceNode, style)
{
	if (content != null)
	{
		minimizable = (minimizable == null) ? true : minimizable;
...
{
	style = (style == null) ? 'mxWindow' : style;
	...
	this.title.append(this.buttons);
	
	tr.append(this.title);
	tbody.append(tr);
	...
	this.td.append(this.contentWrapper);
	tr.append(this.td);
	tbody.append(tr);
...
mxWindow.prototype.activate = function()
{
	if (mxWindow.activeWindow != this)
	{
		...
		this.getElement().style.zIndex = Number.parseInt(index) + 1;
...
mxWindow.prototype.installMinimizeHandler = function()
{
	...
	this.buttons.append(this.minimizeImg);
...
mxWindow.prototype.installMaximizeHandler = function()
{
	...
	this.buttons.append(this.maximize);
...
mxWindow.prototype.installCloseHandler = function()
{
	...
	this.buttons.append(this.closeImg);
