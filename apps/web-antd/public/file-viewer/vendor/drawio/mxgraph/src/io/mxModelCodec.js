...
mxCodecRegistry.register(function()
{
	 ...
	 */
	const codec = new mxObjectCodec(new mxGraphModel());
	...
	codec.encodeObject = function(enc, obj, node)
	{
		...
		{
			const defs = this.encodeResources(enc, rootNode,
	...
	{
		const cells = rootNode.getElementsByTagName('mxCell');
		const lookup = {};
	...
	{
		const cells = child.parentNode.getElementsByTagName('mxCell');
		const defs = child.getElementsByTagName('def');
