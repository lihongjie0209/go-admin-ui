...
function mxArrow(points, fill, stroke, strokewidth, arrowWidth, spacing, endSize)
{
	...
	this.arrowWidth = (arrowWidth == null) ? mxConstants.ARROW_WIDTH : arrowWidth;
	this.spacing = (spacing == null) ? mxConstants.ARROW_SPACING : spacing;
	this.endSize = (endSize == null) ? mxConstants.ARROW_SIZE : endSize;
};
