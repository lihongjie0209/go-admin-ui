...
function mxHierarchicalLayout(graph, orientation, deterministic)
{
	...
	this.orientation = (orientation == null) ? mxConstants.DIRECTION_NORTH : orientation;
	this.deterministic = (deterministic == null) ? true : deterministic;
};
...
mxHierarchicalLayout.prototype.getVisibleTerminal = function(edge, source)
{
	...
	if (terminal == null)
	{
		terminal = (state == null) ? this.graph.view.getVisibleTerminal(edge, source) : state.getVisibleTerminal(source);
	}
...
{
	const placementStage = new mxCoordinateAssignment(this, this.intraCellSpacing,
