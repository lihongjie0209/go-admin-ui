...
<template>
  <VbenAdminLayout
    ...
    :header-toggle-sidebar-button="
      preferences.widget.sidebarToggle && !route.meta.hideSidebar
    "
    ...
    :sidebar-hidden="preferences.sidebar.hidden || route.meta.hideSidebar"
    ...
    :tabbar-enable="preferences.tabbar.enable && !route.meta.hideTabbar"
