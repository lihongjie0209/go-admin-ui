  ...
  return [
    {
      ...
      plugins: () => [
        viteVue({
          // Watcher events can arrive before buildStart initializes the compiler.
          // Resolve from the application to keep its Vue/compiler versions aligned.
          compiler: createRequire(`${process.cwd()}/package.json`)(
            'vue/compiler-sfc',
          ),
          script: {
            defineModel: true,
